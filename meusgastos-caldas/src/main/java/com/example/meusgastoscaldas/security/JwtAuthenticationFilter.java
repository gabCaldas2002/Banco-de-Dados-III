...
import com.example.meusgastoscaldas.domain.dto.usuario.LoginRequestDTO;
import com.example.meusgastoscaldas.domain.dto.usuario.LoginResponseDTO;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            throw new BadCredentialsException("Usuário ou senha inválidos!", null);
        }catch(Exception e){
    ...
    @Override
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws java.io.IOException{
